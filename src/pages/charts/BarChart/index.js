          ...
          <div style={{ marginRight: '-15px', marginLeft: '-15px' }}>
            <div className={styles.colItem}>
              <div className={styles.listLtem}>
                <a target="_blank" href="./editor.html?c=line-simple">
                  <img
                  src="https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb/bar-background.webp?_v_=1627897138964"
            ...
            <div className={styles.colItem}>
              <div className={styles.listLtem}>
                <a target="_blank" href="./editor.html?c=line-simple">
                  <img
                  src="https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb/bar-label-rotation.webp?_v_=1627897138964"
                  />
            ...
            <div className={styles.colItem}>
              <div className={styles.listLtem}>
                <a target="_blank" href="./editor.html?c=line-simple">
                  <img
                  src="https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb/bar-stack.webp?_v_=1627897138964"
                  />
            ...
            <div className={styles.colItem}>
              <div className={styles.listLtem}>
                <a target="_blank" href="./editor.html?c=line-simple">
                  <img
                  src="https://cdn.jsdelivr.net/gh/apache/echarts-website@asf-site/examples/data/thumb/bar-y-category-stack.webp?_v_=1627897138964"
                  />
